...
<template>
  <div v-if="game" class="flex-auto overflow-y-auto">
    <div
      :style="{ background: game.fields.couleur }"
      class="flex flex-col"
    >
      <section
      ...
      <section class="relative flex-auto mt-[336px] bg-white px-9 py-12 rounded-t-[36px] overflow-hidden">
        ...
        <ul class="pb-[106px] space-y-5 overflow-y-auto">
          <li
