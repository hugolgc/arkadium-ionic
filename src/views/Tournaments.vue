...
<template>
  <section class="flex-auto bg-white px-9 py-12 rounded-t-[36px] overflow-y-auto">
      <h1 class="pb-8 text-[26px] text-blue-dark font-bold">⚡️ Tournois</h1>
...
<style>
.z-30 {
  box-shadow: 0px 16px 8px -8px rgba(0, 0, 0, .2);
}
</style>